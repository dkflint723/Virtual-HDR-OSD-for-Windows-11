...
HELP_SECTIONS: tuple[tuple[str, str], ...] = (
    (
        ...
        "actually does, including a 33-point greyscale ramp that becomes the profile's own "
        "tone curve. The sliders and the test patterns are a subjective, by-eye layer on top of "
        "either.\n\n"
